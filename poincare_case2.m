% This code computes the unsteady Couette problem in Fig. 9b
%
% Yidan Xue, Jul 2024
...
h = @(x) x - 0.5i*D + 1i*amp*sin(x);
X = linspace(0,2*pi,m*2+1)'; X = X(1:end-1);
bot = h(X(end:-1:1));
Z = [top; bot]; 
...
exportgraphics(gcf,'./poincare_case2.pdf','Resolution',600)
